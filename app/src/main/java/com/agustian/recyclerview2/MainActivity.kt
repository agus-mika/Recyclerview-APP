package com.agustian.recyclerview2
...
import com.agustian.recyclerview2.adapter.AdapterTeamBola
import com.agustian.recyclerview2.databinding.ActivityMainBinding
import com.agustian.recyclerview2.model.Pemain
        ...
        binding.list.adapter = AdapterTeamBola(this,listPemain,object : AdapterTeamBola.OnClicklistener{
            override fun detailData(item: Pemain?) {
                Dialog(this@MainActivity).apply {
                    ...
                    val name = this.findViewById<TextView>(R.id.txtnamaPemain)
